...
To get the colour code on each colour module click on the copy icon and the HEX code will get copied. Alternatively download the files above to obtain the other colour codes.
