            ...
            <div class="dwl-container">
                ...
                <form target="_blank" onsubmit="this.action = document.getElementById('logo-fiware-accelerator').value">
                    <select id="logo-fiware-accelerator">
                        ...
                        <option value="https://www.fiware.org/custom/brand-guide/img/logo/ecosystem/accelerator/eps/logo-fiware-accelerator.eps">EPS</option>
                    </select>
                ...
                <div class="dwl-container">
                    ...
                    <form target="_blank" onsubmit="this.action = document.getElementById('logo-fiware-accelerator-black').value">
                        <select id="logo-fiware-accelerator-black">
                            ...
                            <option value="https://www.fiware.org/custom/brand-guide/img/logo/ecosystem/accelerator/eps/logo-fiware-accelerator-black.eps">EPS</option>
                        </select>
                        <input type="submit" value="download" class="material-symbols-outlined dwl" />
                    </form>
                </div>
                ...
                <div class="dwl-container">
                    ...
                    <form target="_blank" onsubmit="this.action = document.getElementById('logo-fiware-accelerator-white').value">
                        <select id="logo-fiware-accelerator-white">
                            ...
                            <option value="https://www.fiware.org/custom/brand-guide/img/logo/ecosystem/accelerator/eps/logo-fiware-accelerator-white.eps">EPS</option>
                        </select>
                        <input type="submit" value="download" class="material-symbols-outlined dwl" />
                    </form>
                </div>
            ...
            <div class="dwl-container">
                ...
                <form target="_blank" onsubmit="this.action = document.getElementById('logo-fiware-ihubs').value">
                    <select id="logo-fiware-ihubs">
                        ...
                        <option value="https://www.fiware.org/custom/brand-guide/img/logo/ecosystem/ihubs/eps/logo-fiware-ihubs.eps">EPS</option>
                    </select>
                    <input type="submit" value="download" class="material-symbols-outlined dwl" />
                </form>
            </div>
                ...
                <div class="dwl-container">
                    ...
                    <form target="_blank" onsubmit="this.action = document.getElementById('logo-fiware-ihubs-blue').value">
                        <select id="logo-fiware-ihubs-blue">
                            ...
                            <option value="https://www.fiware.org/custom/brand-guide/img/logo/ecosystem/ihubs/eps/logo-fiware-ihubs-blue.eps">EPS</option>
                        </select>
                        <input type="submit" value="download" class="material-symbols-outlined dwl" />
                    </form>
                </div>
                ...
                <div class="dwl-container">
                    ...
                    <form target="_blank" onsubmit="this.action = document.getElementById('logo-fiware-ihubs-black').value">
                        <select id="logo-fiware-ihubs-black">
                            ...
                            <option value="https://www.fiware.org/custom/brand-guide/img/logo/ecosystem/ihubs/eps/logo-fiware-ihubs-black.eps">EPS</option>
                        </select>
                        <input type="submit" value="download" class="material-symbols-outlined dwl" />
                    </form>
                </div>
                ...
                <div class="dwl-container">
                    ...
                    <form target="_blank" onsubmit="this.action = document.getElementById('logo-fiware-ihubs-white').value">
                        <select id="logo-fiware-ihubs-white">
                            ...
                            <option value="https://www.fiware.org/custom/brand-guide/img/logo/ecosystem/ihubs/eps/logo-fiware-ihubs-white.eps">EPS</option>
                        </select>
                        <input type="submit" value="download" class="material-symbols-outlined dwl" />
                    </form>
                </div>
...
<p class="description">Impact Stories are true inspiring stories of innovation and business impact from the FIWARE Community for the world of users and those looking for best practices. This logo type has no icon but is purely name-based with a ‘frame’, a speech bubble. The name says “FIWARE Impact Stories” to show in one blink of an eye what the reader can expect.</p>
<div class="primary-btn">
            ...
            <div class="dwl-container">
                ...
                <form target="_blank" onsubmit="this.action = document.getElementById('logo-fiware-impact-stories').value">
                    <select id="logo-fiware-impact-stories">
                        ...
                        <option value="https://www.fiware.org/custom/brand-guide/img/logo/ecosystem/impact-stories/eps/logo-fiware-impact-stories.eps">EPS</option>
                    </select>
                    <input type="submit" value="download" class="material-symbols-outlined dwl" />
                </form>
            </div>
                ...
                <button class="copy" data-clipboard-text="https://www.fiware.org/custom/brand-guide/img/logo/ecosystem/impact-stories/svg/logo-fiware-impact-stories-black.svg" data-original-title="Copied!"><span class="material-symbols-outlined">content_copy</span></button>
                    <form target="_blank" onsubmit="this.action = document.getElementById('logo-fiware-impact-stories-black').value">
                        <select id="logo-fiware-impact-stories-black">
                            ...
                            <option value="https://www.fiware.org/custom/brand-guide/img/logo/ecosystem/impact-stories/eps/logo-fiware-impact-stories-black.eps">EPS</option>
                        </select>
                        <input type="submit" value="download" class="material-symbols-outlined dwl" />
                    </form>
                </div>
                ...
                <div class="dwl-container">
                    ...
                    <form target="_blank" onsubmit="this.action = document.getElementById('logo-fiware-impact-stories-white').value">
                        <select id="logo-fiware-impact-stories-white">
                            ...
                            <option value="https://www.fiware.org/custom/brand-guide/img/logo/ecosystem/impact-stories/eps/logo-fiware-impact-stories-white.eps">EPS</option>
                        </select>
                        <input type="submit" value="download" class="material-symbols-outlined dwl" />
                    </form>
                </div>
...
## FIWARE Lab
<p class="description">FIWARE Lab is the non-commercial sandbox environment of the FIWARE Community. It offers for free the capability to innovate and experiment with the FIWARE Technologies. The FIWARE Lab logo consists of a name (FIWARE Lab) and the shapes of four circles. Least symbolize the many and diverse locations and types of FIWARE Labs existing, in a modern and minimalistic way.</p>
<div class="primary-btn">
            ...
            <div class="dwl-container">
                ...
                <form target="_blank" onsubmit="this.action = document.getElementById('logo-fiware-lab').value">
                    <select id="logo-fiware-lab">
                        ...
                        <option value="https://www.fiware.org/custom/brand-guide/img/logo/ecosystem/fiware-lab/eps/logo-fiware-lab.eps">EPS</option>
                    </select>
                    <input type="submit" value="download" class="material-symbols-outlined dwl" />
                </form>
            </div>
                ...
                <div class="dwl-container">
                    ...
                    <form target="_blank" onsubmit="this.action = document.getElementById('logo-fiware-lab-blue').value">
                        <select id="logo-fiware-lab-blue">
                            ...
                            <option value="https://www.fiware.org/custom/brand-guide/img/logo/ecosystem/fiware-lab/eps/logo-fiware-lab-blue.eps">EPS</option>
                        </select>
                        <input type="submit" value="download" class="material-symbols-outlined dwl" />
                    </form>
                </div>
                ...
                <div class="dwl-container">
                    ...
                    <form target="_blank" onsubmit="this.action = document.getElementById('logo-fiware-lab-black').value">
                        <select id="logo-fiware-lab-black">
                            ...
                            <option value="https://www.fiware.org/custom/brand-guide/img/logo/ecosystem/fiware-lab/eps/logo-fiware-lab-black.eps">EPS</option>
                        </select>
                        <input type="submit" value="download" class="material-symbols-outlined dwl" />
                    </form>
                </div>
                ...
                <div class="dwl-container">
                    ...
                    <form target="_blank" onsubmit="this.action = document.getElementById('logo-fiware-lab-white').value">
                        <select id="logo-fiware-lab-white">
                            ...
                            <option value="https://www.fiware.org/custom/brand-guide/img/logo/ecosystem/fiware-lab/eps/logo-fiware-lab-white.eps">EPS</option>
                        </select>
                        <input type="submit" value="download" class="material-symbols-outlined dwl" />
                    </form>
                </div>
            ...
            <div class="dwl-container">
                ...
                <form target="_blank" onsubmit="this.action = document.getElementById('logo-fiware-marketplace').value">
                    <select id="logo-fiware-marketplace">
                        ...
                        <option value="https://www.fiware.org/custom/brand-guide/img/logo/ecosystem/marketplace/eps/logo-fiware-marketplace.eps">EPS</option>
                    </select>
                    <input type="submit" value="download" class="material-symbols-outlined dwl" />
                </form>
            </div>
                ...
                <div class="dwl-container">
                    ...
                    <form target="_blank" onsubmit="this.action = document.getElementById('logo-fiware-marketplace-blue').value">
                        <select id="logo-fiware-marketplace-blue">
                            ...
                            <option value="https://www.fiware.org/custom/brand-guide/img/logo/ecosystem/marketplace/eps/logo-fiware-marketplace-blue.eps">EPS</option>
                        </select>
                        <input type="submit" value="download" class="material-symbols-outlined dwl" />
                    </form>
                </div>
                ...
                <div class="dwl-container">
                    ...
                    <form target="_blank" onsubmit="this.action = document.getElementById('logo-fiware-marketplace-black').value">
                        <select id="logo-fiware-marketplace-black">
                            ...
                            <option value="https://www.fiware.org/custom/brand-guide/img/logo/ecosystem/marketplace/eps/logo-fiware-marketplace-black.eps">EPS</option>
                        </select>
                        <input type="submit" value="download" class="material-symbols-outlined dwl" />
                    </form>
                </div>
                ...
                <div class="dwl-container">
                    ...
                    <form target="_blank" onsubmit="this.action = document.getElementById('logo-fiware-marketplace-white').value">
                        <select id="logo-fiware-marketplace-white">
                            ...
                            <option value="https://www.fiware.org/custom/brand-guide/img/logo/ecosystem/marketplace/eps/logo-fiware-marketplace-white.eps">EPS</option>
                        </select>
                        <input type="submit" value="download" class="material-symbols-outlined dwl" />
                    </form>
                </div>
            ...
            <div class="dwl-container">
                ...
                <form target="_blank" onsubmit="this.action = document.getElementById('logo-fisab').value">
                    <select id="logo-fisab">
                        ...
                        <option value="https://www.fiware.org/custom/brand-guide/img/logo/ecosystem/fisab/eps/logo-fisab.eps">EPS</option>
                    </select>
                    <input type="submit" value="download" class="material-symbols-outlined dwl" />
                </form>
            </div>
                ...
                <div class="dwl-container">
                    ...
                    <form target="_blank" onsubmit="this.action = document.getElementById('logo-fisab-blue').value">
                        <select id="logo-fisab-blue">
                            ...
                            <option value="https://www.fiware.org/custom/brand-guide/img/logo/ecosystem/fisab/eps/logo-fisab-blue.eps">EPS</option>
                        </select>
                        <input type="submit" value="download" class="material-symbols-outlined dwl" />
                    </form>
                </div>
                ...
                <div class="dwl-container">
                    ...
                    <form target="_blank" onsubmit="this.action = document.getElementById('logo-fisab-black').value">
                        <select id="logo-fisab-black">
                            ...
                            <option value="https://www.fiware.org/custom/brand-guide/img/logo/ecosystem/fisab/eps/logo-fisab-black.eps">EPS</option>
                        </select>
                        <input type="submit" value="download" class="material-symbols-outlined dwl" />
                    </form>
                </div>
                ...
                <div class="dwl-container">
                    ...
                    <form target="_blank" onsubmit="this.action = document.getElementById('logo-fisab-white').value">
                        <select id="logo-fisab-white">
                            ...
                            <option value="https://www.fiware.org/custom/brand-guide/img/logo/ecosystem/fisab/eps/logo-fisab-white.eps">EPS</option>
                        </select>
                        <input type="submit" value="download" class="material-symbols-outlined dwl" />
                    </form>
                </div>
